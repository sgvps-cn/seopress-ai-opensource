 ...
 * 月之暗面 Kimi AI 适配器
 * 
 * Moonshot AI Kimi 模型适配器，使用 OpenAI 兼容接口
 * 
 * @package SeoPress_AI
 * @since 1.0.0
 */
...
class SeoPress_AI_Kimi implements SeoPress_AI_Provider_Interface {
    ...
    private function get_api_key(): string {
        ...
        return isset( $options['kimi_api_key'] ) ? $options['kimi_api_key'] : '';
    }
    ...
    public function generate_content( string $prompt, array $options = array() ): array {
        ...
        $body = array(
            ...
            'messages'    => array(
                array(
                    'role'    => 'system',
                    'content' => '你是 Kimi，由 Moonshot AI 提供的人工智能助手。你是一个专业的SEO内容写作专家，擅长撰写高质量、对搜索引擎友好的中文文章。',
                ),
                array(
                    'role'    => 'user',
                    'content' => $prompt,
    ...
    public function get_settings_fields(): array {
        return array(
            array(
                ...
                'label'       => 'Kimi API 密钥',
                'type'        => 'password',
                'description' => '从 platform.moonshot.cn 获取 API 密钥',
            ),
        );
    }
}

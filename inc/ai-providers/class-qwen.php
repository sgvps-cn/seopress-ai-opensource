...
class SeoPress_AI_Qwen implements SeoPress_AI_Provider_Interface {
    
    /**
     * API 端点（北京地域）
     */
    private const API_ENDPOINT = 'https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions';
    ...
    private function get_api_key(): string {
        ...
        return isset( $options['qwen_api_key'] ) ? $options['qwen_api_key'] : '';
    }
    ...
    public function get_settings_fields(): array {
        return array(
            array(
                ...
                'label'       => '通义千问 API 密钥',
                'type'        => 'password',
                'description' => '从阿里云百炼平台获取 DashScope API 密钥',
            ),
        );
    }
}

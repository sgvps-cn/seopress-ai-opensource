...
class SeoPress_AI_Ernie implements SeoPress_AI_Provider_Interface {
    
    /**
     * API 端点
     */
    private const API_ENDPOINT = 'https://qianfan.baidubce.com/v2/chat/completions';
    
    /**
     * 默认模型
     */
    private const DEFAULT_MODEL = 'ernie-3.5-8k';
    ...
    private function get_api_key(): string {
        ...
        return isset( $options['ernie_api_key'] ) ? $options['ernie_api_key'] : '';
    }
    ...
    public function get_settings_fields(): array {
        return array(
            array(
                ...
                'label'       => '百度文心 API 密钥',
                'type'        => 'password',
                'description' => '从百度智能云千帆平台获取 API 密钥',
            ),
        );
    }
}
